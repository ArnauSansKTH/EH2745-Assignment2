...
public class Kmeans {
	...
	public void DeNorm(double[][] FinalC1, double[][] FinalC2, double[][] FinalC3, double[][] FinalC4,
			           int counter1, int counter2, int counter3, int counter4, String USERN, String PASSW){

		PointbyPoint MeasList = new PointbyPoint(USERN, PASSW);
    ...
    /////////// Start KMeans Method	///////////
	public void KMeansMethod(String USERN, String PASSW) {
		
		// Creating new list of measurement points and normalized values
		PointbyPoint measurementList = new PointbyPoint(USERN, PASSW);
